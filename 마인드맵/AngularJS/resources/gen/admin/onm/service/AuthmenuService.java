...
import com.anylogic.iot.api.admin.onm.mapper.AuthmenuMapper;
...
public class AuthmenuService {
    ...
    public int insertAuthMenu(Map<String, Object> parameter){
    	return authmenuMapper.insertAuthMenu(parameter);
    }
