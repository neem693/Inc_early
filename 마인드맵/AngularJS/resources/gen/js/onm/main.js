...
function MainController($rootScope, $scope, $timeout, Version, onmDataService, $state, $stateParams, checkUtil, checkRV) {
    ...
    $scope.selectMyMenu = function() {
        ...
        onmDataService.selectList(param, '/admin/onm/selectMyMenu')
