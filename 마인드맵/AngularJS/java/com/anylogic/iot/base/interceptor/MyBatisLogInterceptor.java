package com.anylogic.iot.base.interceptor;
...
public class MyBatisLogInterceptor implements Interceptor {
    ...
    private static Logger logger = LoggerFactory.getLogger(MyBatisLogInterceptor.class);
        	 ...
        	 */
                ...
                for(ParameterMapping mapping : paramMapping){
                    ...
                    if(value instanceof String){			// SQL의 ? 대신에 실제 값을 넣는다. 이때 String 일 경우는 '를 붙여야 하기땜에 별도 처리
                    	value = ((String) value).replaceAll("[$]", "convert param"); 
                    	/*if("$".equals(value)){
                    		 value = "\\$";
                    	 }*/
