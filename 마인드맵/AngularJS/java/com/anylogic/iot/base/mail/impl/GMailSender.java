 ...
 *  Package : com.anylogic.iot.base.common.mail.impl
 * </PRE>
 ...
 *        jun  : 2015. 6. 25.       :            : 신규 개발.
 */
package com.anylogic.iot.base.mail.impl;
 ...
 * @brief   :
 */
public class GMailSender implements com.anylogic.iot.base.mail.SendMail{
	...
	public static String DEFAULT_SMTP_HOST = PropUtil.getInstance().getPropValue(com.anylogic.iot.base.mail.MailConstants.DEFAULT_MAIL_TEMPLATE_PROPERTICE,
			com.anylogic.iot.base.mail.MailConstants.MAIL_AUTH_HOST);
	public static int DEFAULT_SMTP_PORT = Integer.parseInt(PropUtil.getInstance().getPropValue(com.anylogic.iot.base.mail.MailConstants.DEFAULT_MAIL_TEMPLATE_PROPERTICE,
			com.anylogic.iot.base.mail.MailConstants.MAIL_AUTH_PORT));

	private static String _authId = PropUtil.getInstance().getPropValue(com.anylogic.iot.base.mail.MailConstants.DEFAULT_MAIL_TEMPLATE_PROPERTICE,
			com.anylogic.iot.base.mail.MailConstants.MAIL_AUTH_ID);
	
	private static String _authPw = PropUtil.getInstance().getPropValue(com.anylogic.iot.base.mail.MailConstants.DEFAULT_MAIL_TEMPLATE_PROPERTICE,
			com.anylogic.iot.base.mail.MailConstants.MAIL_AUTH_PW);
	...
	/* (non-Javadoc)
	 * @see com.anylogic.iot.base.common.mail.SendMail#sendMailForHtml(java.lang.String, java.util.List, java.lang.String, java.lang.String, java.util.Date)
	 */
	@Override
