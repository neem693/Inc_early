...
import com.anylogic.iot.api.admin.onm.service.AuthmenuService;
...
public class AuthmenuController {
    ...
    @RequestMapping(value = "/insertAuthMenu", method = RequestMethod.POST)
    public void insertAuthMenu(@RequestBody Map<String, Object> parameter, Messages messages) {
        int res = 0;
        ...
        for (int i = 0; i < sendParam.size(); i++) {
            res = authmenuService.insertAuthMenu(sendParam.get(i));
